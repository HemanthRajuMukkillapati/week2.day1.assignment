package week2.day1.assignment;
	...
	public class DuplicateLead {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Hety's Org"); //Enter CompanyName Field Using id Locator and using as variable since in Duplicate page also same id.
			...
			driver.findElement(By.linkText("Duplicate Lead")).click(); //click on Duplicate
			 
			WebElement compnayName = driver.findElement(By.id("createLeadForm_companyName"));
			compnayName.clear();
			String updateComp="company updated to new";     //update companyname variable
			String updateFName="UpdatedName";				//update First name variable
			compnayName.sendKeys(updateComp);
			WebElement firstName = driver.findElement(By.id("createLeadForm_firstName"));
			firstName.clear();
			firstName.sendKeys(updateFName);
